...
**Settings → Source control → Clone hosted repository → Browse accounts and repositories**
lets you select an accessible repository before entering its destination on the connected host.
GitHub/GitLab accounts and groups, Bitbucket workspaces, and Azure projects within an entered
organization use the host's active credentials. Filtering matches loaded names; use paging for more.
[Provider boundaries, T3 comparison and validation](Docs/HOSTING-REPOSITORY-BROWSER-2026-09-10.md).
