...
public sealed record PiProviderStatus(string ProviderId, string DisplayName, bool CredentialConfigured,
    string CredentialSource, int ModelCount, bool SupportsOAuth = false, bool SupportsApiKey = false);
public sealed record PiResourcesSnapshot(string AgentDirectory, string ProjectDirectory, bool ProjectTrusted,
    ...
    PiToolInventory? ToolInventory = null, PiNativePreferences? NativePreferences = null, bool AuthoritativeResources = false, string? ToolExecution = null, bool SupportsDesktopComponents = false);
...
public sealed record ManagePiResourcesRequest(ThreadId ThreadId, string Action = "inspect", string? ResourceId = null,
    ...
    string? Transport = null, string? AuthType = null, string? ToolExecution = null);
