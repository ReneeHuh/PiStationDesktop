...
public sealed class RemoteAuthorizationFilter : IHubFilter
{
    ...
    public static IReadOnlyDictionary<string, RemoteAccessLevel> MethodAccess { get; } =
        new Dictionary<string, RemoteAccessLevel>(StringComparer.Ordinal)
        {
            ...
            [nameof(EnvironmentHub.UploadBrowserRecording)] = RemoteAccessLevel.Operate,
            ...
            [nameof(EnvironmentHub.ReadThreadHistory)] = RemoteAccessLevel.ReadOnly,
            ...
            [nameof(EnvironmentHub.GetUsageDashboard)] = RemoteAccessLevel.ReadOnly,
            [nameof(EnvironmentHub.GetUsageLimits)] = RemoteAccessLevel.ReadOnly,
            [nameof(EnvironmentHub.RefreshUsageLimits)] = RemoteAccessLevel.Operate,
            [nameof(EnvironmentHub.SaveUsageLimitSource)] = RemoteAccessLevel.Operate,
            [nameof(EnvironmentHub.RemoveUsageLimitSource)] = RemoteAccessLevel.Operate,
            [nameof(EnvironmentHub.RefreshUsageDashboard)] = RemoteAccessLevel.Operate,
            [nameof(EnvironmentHub.ReportClientActivity)] = RemoteAccessLevel.ReadOnly,
            [nameof(EnvironmentHub.SaveRuntimeHealthSettings)] = RemoteAccessLevel.Operate,
            [nameof(EnvironmentHub.ClearRuntimeHealth)] = RemoteAccessLevel.Operate,
            [nameof(EnvironmentHub.TerminateDiagnosticProcess)] = RemoteAccessLevel.Operate,
